 ...
 */
public class RunLuaCallbacksObjectTest extends GuiTest {
    @Override
    ...
    @Test
    public void testRunLuaCallbacksObject() {
        TabPane tabPane = find("#tabPane");
        Tab expectedTab = lookupTab(tabPane, "Callback Functions Object");
        ...
        Platform.runLater(() -> {
            ...
            codeTextArea.appendText("    callbackStore:addCallback(\"test\", function(supplier) return supplier:get() .. supplier:get() end)");
            codeTextArea.appendText(System.lineSeparator());
